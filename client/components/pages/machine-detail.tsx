                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">{machine.weight.toLocaleString()} lbs</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{machine.hoursUsed.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium capitalize">{machine.condition}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{machine.warranty}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                <div className="text-center space-y-2">
                  <div className="text-3xl font-bold text-gray-900">${machine.price.toLocaleString()}</div>
                  <div className="flex items-center justify-center space-x-1">
                    <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                    <span className="font-medium">{machine.rating}</span>
                    <span className="text-gray-500">({machine.reviews} reviews)</span>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold">{machine.sellerName}</p>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">{machine.sellerPhone}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Mail className="w-4 h-4 text-gray-400" />
                    <span className="text-sm">{machine.sellerEmail}</span>
                  </div>
                </div>
